#ifndef ALLOC_SINGLE_THREAD_FIRST_FIT_PARTITION_NONE_HPP
#define ALLOC_SINGLE_THREAD_FIRST_FIT_PARTITION_NONE_HPP
...
class alloc_sthread_first_fit_part_none_impl {
public:
              alloc_sthread_first_fit_part_none_impl( size_t block_size ); //self initialize block from system
              alloc_sthread_first_fit_part_none_impl( void * p, size_t size ); //inherit a block from elsewhere
              ~alloc_sthread_first_fit_part_none_impl();
